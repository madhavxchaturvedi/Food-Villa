...
const Header = () => {
  ...
  return (
    user && (
      <div className="z-60 navbar flex justify-center sticky top-0 w-full bg-[#28282B] h-24 pt-5 shadow-lg shadow-gray-500">
          ...
          <div className="nav-items flex gap-4  pt-2 text-white text-[1.25rem]  pr-6 work-sans-nav-items ">
            ...
            <ul className="flex">
              ...
              <Link to="/cart">
                <li>
                  <button
                    className="px-4 py-1 bg-white cursor-pointer text-[#EB5B00] rounded-md hover:scale-105 transition ease-in"
                    data-testid="cart"
                  >
